...
def parser():
    parser = argparse.ArgumentParser(description="Darknet\'s yolov3.cfg and yolov3.h5 \
                                      converted into Keras\'s yolov3.weights!")
    parser.add_argument('-cfg_path', help='yolov3.cfg')
    parser.add_argument('-h5_path', help='yolo1_weights.h5')
    parser.add_argument('-output_path', help='yolo1.weights')
